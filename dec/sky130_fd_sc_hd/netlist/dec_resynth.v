...
module dec(count, selectp1, selectp2);
  ...
  wire [127:0] selectp2;
  sky130_fd_sc_hd__nand4bb_1 _032_ (
    .A_N(count[0]),
    .B_N(count[3]),
    .C(count[1]),
    .D(count[2]),
  ...
  sky130_fd_sc_hd__nand4_1 _047_ (
    .A(count[0]),
    .B(count[3]),
    .C(count[1]),
    .D(count[2]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _048_ (
    .A_N(count[7]),
    .B_N(count[4]),
    .C(count[5]),
    .D(count[6]),
  ...
  sky130_fd_sc_hd__nand4b_1 _050_ (
    .A_N(count[0]),
    .B(count[3]),
    .C(count[1]),
    .D(count[2]),
  ...
  sky130_fd_sc_hd__nand4b_1 _052_ (
    .A_N(count[1]),
    .B(count[2]),
    .C(count[0]),
    .D(count[3]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _054_ (
    .A_N(count[0]),
    .B_N(count[1]),
    .C(count[2]),
    .D(count[3]),
  ...
  sky130_fd_sc_hd__nand4b_1 _056_ (
    .A_N(count[2]),
    .B(count[1]),
    .C(count[3]),
    .D(count[0]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _058_ (
    .A_N(count[0]),
    .B_N(count[2]),
    .C(count[1]),
    .D(count[3]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _060_ (
    .A_N(count[1]),
    .B_N(count[2]),
    .C(count[0]),
    .D(count[3]),
  ...
  sky130_fd_sc_hd__nand4b_1 _064_ (
    .A_N(count[3]),
    .B(count[1]),
    .C(count[2]),
    .D(count[0]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _073_ (
    .A_N(count[7]),
    .B_N(count[5]),
    .C(count[4]),
    .D(count[6]),
  ...
  sky130_fd_sc_hd__nand4b_1 _209_ (
    .A_N(count[5]),
    .B(count[4]),
    .C(count[7]),
    .D(count[6]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _226_ (
    .A_N(count[5]),
    .B_N(count[4]),
    .C(count[7]),
    .D(count[6]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _260_ (
    .A_N(count[6]),
    .B_N(count[4]),
    .C(count[5]),
    .D(count[7]),
  ...
  sky130_fd_sc_hd__nand4bb_1 _277_ (
    .A_N(count[6]),
    .B_N(count[5]),
    .C(count[4]),
    .D(count[7]),
